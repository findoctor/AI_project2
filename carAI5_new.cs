    ...
    public class CarAI5 : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            if (m_Car.CurrentSpeed > 10f) {
                if (transform.name == "ArmedCar (2)" && m_Car.CurrentSpeed > 11.0f)  // 11.1 --> 122 health
                    acc = 0f;
                if (transform.name == "ArmedCar (4)" && m_Car.CurrentSpeed > 10f)
                    acc = 0f;
                if (transform.name == "ArmedCar (3)" && m_Car.CurrentSpeed > 10f)
                    acc = 0f;
            ...
            /* Drive */
            if(transform.name == "ArmedCar (2)" && Time.time > 3f)
                m_Car.Move(steeringAngel, acc, 1f, 0f);
            else if(transform.name == "ArmedCar (3)" && Time.time > 3.04f)
                m_Car.Move(steeringAngel, acc, 1f, 0f);
            else if (transform.name == "ArmedCar (4)" && Time.time > 3.9f)
                m_Car.Move(steeringAngel, acc, 1f, 0f);
